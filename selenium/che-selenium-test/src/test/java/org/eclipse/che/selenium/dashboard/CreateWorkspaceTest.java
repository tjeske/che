...
public class CreateWorkspaceTest {
  ...
  private String projectName = getProjectSampleName();
  private String newProjectName = projectName + "-1";
  private String projectDescription = getProjectSampleDescription();
  ...
  @BeforeMethod
  public void openNewWorkspacePage() {
  ...
  protected String getProjectSampleDescription() {
    return "A basic example using Spring servlets. The app returns values entered into a submit form.";
  }
